...
instance Semigroup WorkflowInboundInterceptor where
  a <> b =
    WorkflowInboundInterceptor
      ...
      , startExecuteWorkflowHook = \input -> a.startExecuteWorkflowHook input . b.startExecuteWorkflowHook input
...
instance Monoid WorkflowInboundInterceptor where
  mempty =
    WorkflowInboundInterceptor
      ...
      , startExecuteWorkflowHook = const id
