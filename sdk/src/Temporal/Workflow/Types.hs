...
childWorkflowCancellationTypeToProto ChildWorkflowCancellationAbandon = ChildWorkflow.ChildWorkflowCancellationType'Abandon
childWorkflowCancellationTypeToProto ChildWorkflowCancellationTryCancel = ChildWorkflow.ChildWorkflowCancellationType'TryCancel
childWorkflowCancellationTypeToProto ChildWorkflowCancellationWaitCancellationCompleted = ChildWorkflow.ChildWorkflowCancellationType'WaitCancellationCompleted
childWorkflowCancellationTypeToProto ChildWorkflowCancellationWaitCancellationRequested = ChildWorkflow.ChildWorkflowCancellationType'WaitCancellationRequested
...
parentClosePolicyToProto ParentClosePolicyUnspecified = ChildWorkflow.ParentClosePolicy'ParentClosePolicyUnspecified
parentClosePolicyToProto ParentClosePolicyTerminate = ChildWorkflow.ParentClosePolicy'ParentClosePolicyTerminate
parentClosePolicyToProto ParentClosePolicyAbandon = ChildWorkflow.ParentClosePolicy'ParentClosePolicyAbandon
parentClosePolicyToProto ParentClosePolicyRequestCancel = ChildWorkflow.ParentClosePolicy'ParentClosePolicyRequestCancel
...
nexusOperationCancellationTypeToProto NexusOperationWaitCancellationCompleted = NexusProto.NexusOperationCancellationType'WaitCancellationCompleted
nexusOperationCancellationTypeToProto NexusOperationAbandon = NexusProto.NexusOperationCancellationType'Abandon
nexusOperationCancellationTypeToProto NexusOperationTryCancel = NexusProto.NexusOperationCancellationType'TryCancel
nexusOperationCancellationTypeToProto NexusOperationWaitCancellationRequested = NexusProto.NexusOperationCancellationType'WaitCancellationRequested
