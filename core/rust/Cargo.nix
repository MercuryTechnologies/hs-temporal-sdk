  ...
  internal = rec {
    ...
    crates = {
      ...
      "gethostname" = rec {
        ...
        version = "1.0.2";
        edition = "2021";
        sha256 = "0mdfkmfr41xx1i0nlwgzncmnj2a5f18kn6ydp7j1qc1q83dpy9gw";
        authors = [
      ...
      "linux-raw-sys" = rec {
        ...
        resolvedDefaultFeatures = [ "elf" "errno" "general" "ioctl" "no_std" "system" ];
      };
      "litemap" = rec {
        crateName = "litemap";
        version = "0.7.5";
      ...
      "rustfsm" = rec {
        ...
        src = pkgs.fetchgit {
          ...
          rev = "23f495a68f4d025e88c4a6859579587079f5460c";
          sha256 = "03mrvdr00vbl4irm588icalnipfg1rcxa0la8vjxk5avacn46hzn";
        };
        authors = [
      ...
      "zip" = rec {
        ...
        version = "2.6.1";
        edition = "2021";
        sha256 = "0i276d0kracqv27f5r42p3ha2345f77isv5rp54sw9i52p829jqx";
        build = "src/build.rs";
        authors = [
