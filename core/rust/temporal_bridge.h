...
typedef struct SlotReserveCompletion SlotReserveCompletion;
 ...
 */
typedef void (*ReserveSlotFn)(const uint8_t *ctx_ptr,
                              uintptr_t ctx_len,
                              struct SlotReserveCompletion *completion);

typedef int32_t (*TryReserveSlotFn)(const uint8_t *ctx_ptr, uintptr_t ctx_len);

typedef void (*MarkSlotUsedFn)(const uint8_t *info_ptr, uintptr_t info_len);

typedef void (*ReleaseSlotFn)(const uint8_t *info_ptr, uintptr_t info_len);
 ...
 */
struct HaskellSlotSupplierInner *hs_temporal_new_custom_slot_supplier(ReserveSlotFn reserve_fn,
                                                                      TryReserveSlotFn try_reserve_fn,
                                                                      MarkSlotUsedFn mark_used_fn,
                                                                      ReleaseSlotFn release_fn);
 ...
 * Haskell FFI bridge invariants.
 */
void hs_temporal_drop_custom_slot_supplier(struct HaskellSlotSupplierInner *handle);
 ...
 * Haskell FFI bridge invariants.
 */
void hs_temporal_slot_reserve_complete(struct SlotReserveCompletion *completion);
